...
df = spark.sql("SELECT CategoryID, CategoryName FROM Bronze_lh_poc_data.Categories")

df.write.mode("overwrite").format("delta").option("overwriteSchema", "true").save("Tables/Categories")
